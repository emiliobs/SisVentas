    ...
    public class DVenta
    {
        ...
        public DataTable BuscarFechas(String TextoBuscar, String TextoBuscar2)
        {
            ...
            try
            {
                ...
                ParTextoBuscar.ParameterName = "@txtBuscar1";
                ...
                ParTextoBuscar2.ParameterName = "@txtBuscar2";
        ...
        public DataTable MostrarDetalle(String TextoBuscar)
        {
            ...
            try
            {
                ...
                SqlParameter ParTextoBuscar = new SqlParameter();
                ParTextoBuscar.ParameterName = "@txtBuscar";
                ParTextoBuscar.SqlDbType = SqlDbType.VarChar;
                ParTextoBuscar.Size = 50;
                ParTextoBuscar.Value = TextoBuscar;
                SqlCmd.Parameters.Add(ParTextoBuscar);
        ...
        public DataTable MostrarArticulo_Venta_codigo(String TextoBuscar)
        {
            ...
            try
            {
                ...
                SqlCommand SqlCmd = new SqlCommand();
                SqlCmd.Connection = SqlCon;
                SqlCmd.CommandText = "spBuscarArticuloVentaCodigo";
                SqlCmd.CommandType = CommandType.StoredProcedure;
