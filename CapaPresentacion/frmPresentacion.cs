...
namespace CapaPresentacion
{
    public partial class frmPresentacion : Form
    {
        ...
        public frmPresentacion()
        {
            ...
            this.TtMensajetoolTip.SetToolTip(this.NombretextBox, "Ingrese el Nombre de la Presentación.....");
        }
        ...
        private void Limpiar()
        {
            ...
            IdPresentaciontextBox.Text = string.Empty;
        }
        ...
        {
            this.dataListadoGridView1.DataSource = NPresentacion.MostrarPresentacion();
        ...
        {
            this.IdPresentaciontextBox.Text = this.dataListadoGridView1.CurrentRow.Cells["idpresentacion"].Value.ToString();
