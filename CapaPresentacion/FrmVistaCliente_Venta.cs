...
namespace CapaPresentacion
{
    public partial class FrmVistaCliente_Venta : Form
    {
        ...
        {
            this.dataListado.DataSource = NCliente.BuscarClienteApellidos(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
        ...
        {
            this.dataListado.DataSource = NCliente.BuscarClienteNumeroDocumento(this.txtBuscar.Text);
            this.OcultarColumnas();
            lblTotal.Text = "Total de Registros: " + Convert.ToString(dataListado.Rows.Count);
        }
